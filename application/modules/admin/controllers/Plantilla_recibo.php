...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(270, -30, utf8_decode("Hora y fecha - Generación del Recibo Depósito: ") . $variable_fecha_finalizacion, 0, 1, "R");
        // RESUMEN DEL INVENTARIO
        $this->SetFont("Arial", "B", 12);
        $this->Cell(270, 0, utf8_decode("CONSOLIDADO DEL RECIBO DE DEPÓSITO"), 0, 1, "C");
        ...
        // Título
        $this->Cell(25);
        $this->Cell(220, 5, utf8_decode("RECIBO DE DEPÓSITO"), 0, 0, "C");
        // Salto de línea
        $this->Ln(10);
    }
    ...
    function campos($label)
    {
        ...
        // Título
        $this->Cell(40, 7, "$label", 1, 0, 'C', true);
    }
     // CODIGO RFID
    ...
    function item($label)
    {
        ...
        $this->SetFillColor(45,243,222);
        // Título
        $this->Cell(20, 7, "$label", 1, 0, 'C', true);
    }
    // GUIA DE REMISION
