...
class Inventario extends MX_Controller
{
    ...
    public function guardar_inventario()
    {
        ...
        $this->load->model('tbl_inventario');
        $codigo = $this->obj_inventario->get_cod_inventario($this->input->post('codigo_sensor'));
        //print_r($codigo->codigo);
        $nombre_imagen = pathinfo($_FILES["name_file"]["name"], PATHINFO_FILENAME);
        $extension_guardar = pathinfo($_FILES["name_file"]["name"], PATHINFO_EXTENSION);
        //print_r($nombre_imagen);
        //print_r($extension_guardar);
        $data = array(
            'codigo' => $this->input->post('codigo_sensor'), //son names
            'descripcion' => $this->input->post('descripcion'),
            'imagen'  => $this->input->post('codigo_sensor') . "." . $extension_guardar
        );
        //print_r($data);
        //Jalar carpeta
        ...
        $config['file_name']           = $this->input->post('codigo_sensor') . "." . $extension_guardar;
