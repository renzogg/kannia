...
<script>
    $(document).ready(function() {
        var table = $('#tbl_movimientos').DataTable({
            ...
            "ajax": {
                url: "<?php echo site_url('admin/inventario_tiempo_real/generar_recibo_deposito/'.$correlativo); ?>",
                type: "post"
    ...
    $("body").on("click", ".btn_reiniciar", function() {
        ...
        $('#miModal').modal();
        $('.reiniciar').attr('href', 'admin/inventario_tiempo_real/reiniciar_generar_recibo_deposito/'+<?php echo $correlativo; ?>);
    });
     // MODAL DE FINALIZACION DE INVENTARIADO
     $("body").on("click", ".btn_finalizar", function() {
        //$('#miModal').modal('show'); //<-- you should use show in this situation
        $('#miModal1').modal();
        $('.finalizar').attr('href', 'admin/inventario_tiempo_real/generar_recibo/'+<?php echo $correlativo; ?>);
    });
</script>
<div>
...
<div class="main-container">
    <div class="row gutter">
        ...
        <div style="float: right; width: 225px">
            <a data-target="#miModal1" data-toggle="miModal1"><button type="submit" class="btn btn-danger btn_finalizar">GENERAR RECIBO DE DEPÓSITO</button></a>
         </div>
        <!--FIN DE BOTON-->
        <!-- BOTON REINICIAR INVENTARIO-->
        <div style="float: left; width: 225px">
            <a data-target="#miModal" data-toggle="miModal"><button type="submit" class="btn btn-success btn_reiniciar">REINICIAR LECTURAS EN TIEMPO REAL</button></a>
        </div>
        <!--FIN DE BOTON-->
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <h4>¿Desea reiniciar la Generación del RECIBO DE DEPOSITO?</h4>
                </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="miModal1" style="max-width: inherit;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <h4>¿Esta seguro que Desea GENERAR EL RECIBO DE DEPOSITO?</h4>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
