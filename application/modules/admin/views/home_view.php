         ...
         $.ajax({
            ...
            success: function(response) {
               ...
               for (ind in respuesta) {
                  ...
                  fila += "<td><img src='static/main/img/" + respuesta[ind].imagen +
                     "' alt='Activo' width='42' height='42' style='vertical-align:bottom'>" +
                     "</td>";
                  if (respuesta[ind].status == "1") {
                     fila += "<td><span class = 'label label-success'>Vinculado</span></td>";
                  } else {
                     fila +=
                        "<td><span class = 'label label-warning'>Sin Vincular</span></td>";
                  }
