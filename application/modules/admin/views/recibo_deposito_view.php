                ...
                success: function(response) {
                    ...
                    for (ind in respuesta) {
                        ...
                        if (respuesta[ind].status == "1") {
                            fila += "<td class='filaProgramada'><span class = 'label label-info'>RECIBO GENERADO</span></td>";
                        } else {
                            fila += "<td style='text-align:center'><a href='admin/inventario_tiempo_real/recibo_deposito/" + respuesta[ind].correlativo + "' class='btn btn-warning'>GENERAR RECIBO</a></td>";
                        }
                        tabla += fila;
                    }
                    ...
                    <table class="table danger table-striped no-margin text-center" id="tbl_vinculacion" class="display">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align:center">RECIBO DE DEPÓSITO</th>
                            </tr>
                        </thead>
                        <tbody id="cuerpo">
                        </tbody>
