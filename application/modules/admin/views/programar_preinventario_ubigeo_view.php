<script>
    $(function() {
        let repetir = function() {
            $.ajax({
                url: "admin/dispositivo_rfid/get_dispositivo_rfid_preinventario",
                type: "post",
                data: {},
                dataType: "json",
        ...
        $("#ubigeo").change(function() {
            ...
            if (ubigeo != "") { //verificar haber seleccionado una opcion valida
                ...
                $.ajax({
                    url: '<?php echo site_url('admin/inventario_tiempo_real/listar_ubicacion_preinventario'); ?>', //url que recibe las variables
                    data: {
                        ubigeo: $("#ubigeo").val()
    ...
    $(function() {
        $("#form_programacion").submit(function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "admin/inventario_tiempo_real/agregar_actividad_preinventario",
                data: datos,
                dataType: "json",
                success: function(resultado) {
                    //console.log(data);
                    jAlert(resultado.respuesta, "Mensaje");
                    window.location.assign("admin/tiemporeal/preinventario_tiempo_real");
                },
