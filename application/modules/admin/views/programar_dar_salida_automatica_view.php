...
<script>
   $(function() {
      let repetir = function() {
         $.ajax({
            url: "admin/dispositivo_rfid/get_dispositivo_rfid_programacion_salida_automatica",
            type: "post",
            data: {},
            dataType: "json",
      ...
      $("#ubigeo").change(function() {
         ...
         if (ubigeo != "") { //verificar haber seleccionado una opcion valida
            ...
            $.ajax({
               url: '<?php echo site_url('admin/vinculacion/listar_ubicacion_tiempo_real'); ?>', //url que recibe las variables
               data: {
                  ubigeo: $("#ubigeo").val()
   ...
   $(function() {
      $("#form_programacion").submit(function(event) {
         ...
         $.ajax({
            type: "POST",
            url: "admin/vinculacion/agregar_actividad_salida",
            data: datos,
            dataType: "json",
            success: function(resultado) {
               //console.log(data);
               //jAlert(resultado.respuesta, "Mensaje");
               window.location.assign("admin/vinculacion/salidas_tiempo_real"); //Actualiza la pagina
            },
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <div class="panel panel-light panel-blue">
            <div class="panel-heading">
               <h4>SALIDAS DE ACTIVOS - TIEMPO REAL</h4>
            </div>
            <div class="panel-body">
               <form class="form-horizontal" id="form_programacion" method="post" action="<?php echo base_url('admin/vinculacion/agregar_actividad') ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                     ...
                     <button type="submit" class="btn btn-success" id="guardar">IR A SALIDAS AUTOMATICAS EN TIEMPO REAL</button>
                  </div>
               </form>
            </div>
         </div>
