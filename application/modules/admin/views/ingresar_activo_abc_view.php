  ...
  $(document).ready(function() {
      var table = $('#tbl_inventario').DataTable({
         ...
         "buttons": [{
            ...
            title: 'Ingreso de Activos - Manual'
         }],
         "ajax": {
         ...
         <div class="panel panel-light panel-brown">
            ...
            <div class="panel-body">
               <form class="form-horizontal" id="form_vinculacion" method="post" action="<?php echo base_url('admin/inventario/guardar_activo') ?>" enctype="multipart/form-data">
                  ...
                  <div class="form-group row gutter">
                     <label for="inputPassword3" class="col-sm-2 control-label">Nro Dam</label>
                     <div class="col-sm-7"><input type="text" class="form-control" placeholder="Ingrese nro_dam" id="nro_dam" name="nro_dam" required></div>
                  </div>
                  <div class="form-group row gutter">
                     <label for="inputPassword3" class="col-sm-2 control-label">Guia de Remisión</label>
                     <div class="col-sm-7"><input type="text" class="form-control" placeholder="Ingrese guia_remision" id="guia_remision" name="guia_remision" required></div>
                  </div>
                  <div class="form-group row gutter">
                     <label for="inputPassword3" class="col-sm-2 control-label">Nro de Operación</label>
                     <div class="col-sm-7"><input type="text" class="form-control" placeholder="Ingrese nro operacion" id="nro_operacion" name="nro_operacion" required></div>
                  </div>
                  <div class="form-group row gutter">
                     <label for="inputPassword3" class="col-sm-2 control-label">Item</label>
                     <div class="col-sm-7"><input type="text" class="form-control" placeholder="Ingrese Item" id="item" name="item" required></div>
                  </div>
                  <div class="form-group row gutter">
                     <label for="inputPassword3" class="col-sm-2 control-label">Familia de Producto</label>
                     <div class="col-sm-7"><input type="text" class="form-control" placeholder="Ingrese familia producto" id="familia_producto" name="familia_producto" required></div>
                  </div>
                  <div class="form-group row gutter">
